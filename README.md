...
Official PyTorch implementation for **[ENCORE: Efficient Noise Context-Aware Representation for Low-Dose CT Denoising](https://arxiv.org/abs/2608.10343)**.
...
## Citation
```bibtex
@misc{yu2026encoreefficientnoisecontextaware,
      title={ENCORE: Efficient Noise Context-Aware Representation for Low-Dose CT Denoising}, 
      author={Minwoo Yu and N. Robert Bennett and Jongduk Baek and Adam S. Wang},
      year={2026},
      eprint={2608.10343},
      archivePrefix={arXiv},
      primaryClass={cs.CV},
      url={https://arxiv.org/abs/2608.10343}, 
}
```
